...
public class SelectConfigData {
    ...
    public CommonItemListener currentPathConfirmListener; //增加确认当前路径按钮

    public CommonItemListener addFolderListener; //增加添加文件夹按钮

    public CommonItemListener deleteListener; //增加删除按钮
    ...
    public void initDefaultConfig(Context context) {
        ...
        pathSelectDialogWidth = ScreenUtils.getScreenWidth() * 40 / 100;
        pathSelectDialogHeight = ScreenUtils.getScreenHeight() * 55 / 100;
    ...
    public void clearAllFragment() {
        if (fileShowFragment != null) {
            if (fileShowFragment.mActivity != null) {
                fileShowFragment.mActivity = null;
            }
            if (fileShowFragment.mIActivityAndFragment != null) {
                fileShowFragment.mIActivityAndFragment = null;
            }
            fileShowFragment = null;
        }

        if (titlebarFragment != null) {
            if (titlebarFragment.mActivity != null) {
                titlebarFragment.mActivity = null;
            }
            if (titlebarFragment.mIActivityAndFragment != null) {
                titlebarFragment.mIActivityAndFragment = null;
            }
            titlebarFragment = null;
        }

        if (tabbarFragment != null) {
            if (tabbarFragment.mActivity != null) {
                tabbarFragment.mActivity = null;
            }
            if (tabbarFragment.mIActivityAndFragment != null) {
                tabbarFragment.mIActivityAndFragment = null;
            }
            tabbarFragment = null;
        }

        if (handleFragment != null) {
            if (handleFragment.mActivity != null) {
                handleFragment.mActivity = null;
            }
            if (handleFragment.mIActivityAndFragment != null) {
                handleFragment.mIActivityAndFragment = null;
            }
            handleFragment = null;
        }
        context = null;
