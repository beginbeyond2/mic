...
public class FileBean implements Serializable {
    ...
    public FileBean(String path, String name, Boolean dir, String fileExtension, Integer fileIcoType, Integer childrenFileNumber, Integer childrenDirNumber, Boolean boxVisible, Boolean boxChecked,
                    Long modifyTime, Long size, DocumentFile documentFile, Boolean useUri, String displayName) {
        this.path = path;
        this.name = name;
        this.dir = dir;
