...
#ifndef OPENCLIMAGE_WINDOW_H
#define OPENCLIMAGE_WINDOW_H
/*
...
int ANativeWindow_dequeueBufferEx(ANativeWindow* window, ANativeWindowBuffer** buffer, int* fenceFd, int *fd);
