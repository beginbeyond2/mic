 ...
 *   <li>设计模式：继承 + 策略模式</li>
 *   <li>适用产品：MHO系列高端示波器（1800M存储深度）</li>
 * </ul>
 * 
 * <p><b>核心职责：</b>
 * <ul>
 *   <li>实现1800M点存储深度的具体计算逻辑</li>
 ...
 *   └── MemDepth (抽象类)
 *          │
 *          ├── MemDepth1800M (当前类 - 1800M点存储深度实现)
 ...
 *   <li>依赖：HwConfig（硬件配置，获取ADC时钟）</li>
...
public class MemDepth1800M extends MemDepth {
     ...
     * 
     * 档位计算：
     *   档位1: 18000 * 1000 * 100 / 通道系数 = 1800M/900M/450M
     *   档位2: 18000 * 1000 * 10 / 通道系数 = 180M/90M/45M
     *   档位3: 18000 * 1000 / 通道系数 = 18M/9M/4.5M
     *   档位4: 18000 * 100 / 通道系数 = 1.8M/900K/450K
     *   档位5: 18000 * 10 / 通道系数 = 180K/90K/45K
     * </pre>
     * 
     * <p><b>Auto模式逻辑：</b>
     * <ul>
     ...
     * </ul>
     * 
     * @param cfg 存储深度基准值（18000，此参数在方法内被覆盖为18M）
     * @param coef 通道系数（通道数/2）
     ...
     *   <li>1800M存储深度实现固定返回1.0</li>
     * </ul>
     * 
     * <p><b>设计说明：</b>
     * <ul>
     *   <li>1800M存储深度示波器不需要时基比例调整</li>
     ...
     * <p><b>功能说明：</b>
     * <ul>
     *   <li>1800M存储深度示波器不支持特殊时基处理</li>
     *   <li>返回false表示不需要进行时基比例调整</li>
     * </ul>
     * 
     * <p><b>设计说明：</b>
     * <ul>
     *   <li>与MemDepth36M不同，1800M版本使用标准时基计算</li>
