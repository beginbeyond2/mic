...
public class TopLayoutUsersetDepth extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_usersetdepth, container, false);
    }
    ...
    private void initView(View view) {
        ...
        viewDepth.setData(R.string.usersetDepth, R.array.usersetDepth, onCheckChangedListener);
    }
    ...
    private void refreshMemDepth(boolean isFromEventBus) {
        ...
        if (!Arrays.equals(memDepths, viewDepth.getArray())) {
            viewDepth.setData(App.get().getString(R.string.usersetDepth), memDepths, onCheckChangedListener);
        }
        int depth;
        if (!isFromEventBus) {
