...
//            new SCPICommandStruct(":TRIGger:SETup:DLEVel?","SCPI_Trigger_Setup","DLevelQ"),//查询建立保持时间触发的数据源触发电平
    ...
    public static void Clock(SCPIParam param){}
    public static void ClockQ(SCPIParam param){}
    public static void Data(SCPIParam param){}
    public static void DataQ(SCPIParam param){}
    public static void Cedge(SCPIParam param){}
    public static void CedgeQ(SCPIParam param){}
    public static void STime(SCPIParam param){}
    public static void STimeQ(SCPIParam param){}
    public static void HTime(SCPIParam param){}
    public static void HTimeQ(SCPIParam param){}
    public static void CLevel(SCPIParam param){}
    public static void CLevelQ(SCPIParam param){}
    public static void DLevel(SCPIParam param){}
    public static void DLevelQ(SCPIParam param){}
