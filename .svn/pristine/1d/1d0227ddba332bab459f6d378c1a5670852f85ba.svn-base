...
/**
 * @auother Liwb
 * @description: TChan的名子来源为:ToolsChannel
 *
 * @data:2024-3-20 10:02
 */
public class TChan {
    //region 常量
     ...
     * rowCursor
     */
    public static final int Cursor_col_1 = 0x41;//行
    public static final int Cursor_col_2 = 0x42;
    /**
     * rowCursor 联动
     */
    public static final int Cursor_col_3 = 0x43;//行联动，点击不选中
    public static final int Cursor_col_4 = 0x44;//行联动，点击选中

    /**
     * colCursor
     */
    public static final int Cursor_row_1 = 0x51;//列
    public static final int Cursor_row_2 = 0x52;
    /**
     * colCursor 联动
     */
    public static final int Cursor_row_3 = 0x53;//列联动，点击不选中
    public static final int Cursor_row_4 = 0x54;//列联动，点击选中
    public static final int Cursor_all = 0x55; //表示选中所有光标
    ...
    /**
     *
     * @param TChanMathNo TChan.Math1~TChan.Math8
     * @return 返回 mathNumber为1开始的整型
     */
    ...
    /**
     *
     * @param TChanRefNo TChan.R1~TChan.R8
     * @return 返回 refNumber为1开始的整型
     */
    ...
    /**
     * 转换到下层可以使用的通道号，从串型通道号
     * @param serialsNumber  串型通道号都是从1开始的
     * @return
     */
    ...
    /**
     *
     * @param TChanSNo TChan.S1~TChan.S4
     * @return 返回 serialsNumber为1开始的整型
     */
