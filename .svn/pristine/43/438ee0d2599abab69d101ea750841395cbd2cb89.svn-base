...
public class ConfigDataBuilderImpl implements IConfigDataBuilder {
    ...
    private SelectConfigData mConfigData = new SelectConfigData();
    ...
    @Override
    public IConfigDataBuilder setCurrentPathConfirmListeners(CommonItemListener handleItemListeners) {
        mConfigData.currentPathConfirmListener = handleItemListeners;
        return this;
    }

    @Override
    public IConfigDataBuilder setAddFolderListener(CommonItemListener handleItemListeners) {
        mConfigData.addFolderListener = handleItemListeners;
        return this;
    }

    public IConfigDataBuilder setDeleteListener(CommonItemListener handleItemListeners) {
        mConfigData.deleteListener = handleItemListeners;
        return this;
    }
    ...
    @Override
    public IConfigDataBuilder setIsFilesOnlyMode(Boolean isFilesOnly) {
        mConfigData.isFilesOnly = isFilesOnly;
        return this;
    }
...
//    }
    ...
    private static volatile ConfigDataBuilderImpl instance;

    public static ConfigDataBuilderImpl getInstance() {
        if (instance == null) {
            synchronized (ConfigDataBuilderImpl.class) {
                if (instance == null) {
                    instance = new ConfigDataBuilderImpl();
                }
            }
        }
        return instance;
    ...
    public static void releaseInstance() {
        if (instance != null && instance.mConfigData != null) {
            instance.mConfigData.clearAllFragment();
