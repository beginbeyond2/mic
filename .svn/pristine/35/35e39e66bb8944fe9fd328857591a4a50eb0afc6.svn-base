...
public interface IConfigDataBuilder {
    ...
    IConfigDataBuilder setCurrentPathConfirmListeners(CommonItemListener handleItemListener);

    IConfigDataBuilder setAddFolderListener(CommonItemListener handleItemListeners);

    IConfigDataBuilder setDeleteListener(CommonItemListener handleItemListeners);

    IConfigDataBuilder setLifeCycle(AbstractLifeCycle lifeCycle);

    IConfigDataBuilder setIsFilesOnlyMode(Boolean isFileWatcher);
