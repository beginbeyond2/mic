...
public abstract class AbstractTitlebarFragment extends AbstractFragment implements ITitlebarFragment {
    ...
    public void initData() {
        psf = (BasePathSelectFragment) mConfigDataReference.get().fragmentManager.findFragmentByTag(MConstants.TAG_ACTIVITY_FRAGMENT);
    ...
    public void setMainTitle(FontBean fontBean){
    ...
    public void initView() {
        super.initView();
        setStatusBarColor(mConfigDataReference.get().statusBarHexColor);
    }
