...
public class PathSelectFragment extends BasePathSelectFragment {
    ...
    public void initData() {
        ...
        //获取Fragment
        titlebarFragment = mConfigDataReference.get().titlebarFragment;
        tabbarFragment = mConfigDataReference.get().tabbarFragment;
        fileShowFragment = mConfigDataReference.get().fileShowFragment;
        handleFragment = mConfigDataReference.get().handleFragment;
    ...
    public List<TabbarFileBean> updateTabbarList() {
        ...
        if (mConfigDataReference.get().showTabbarFragment && tabbarFragment != null) {
    ...
    public SelectConfigData getSelectConfigData() {
        return mConfigDataReference.get();
    }
    ...
    private void showAllFragment() {
        ...
        FragmentTools.fragmentShowHide(
                ...
                mConfigDataReference.get().showTitlebarFragment
        );
        //加载 TabbarFragment
        FragmentTools.fragmentShowHide(
                fragmentManager,
                ...
                mConfigDataReference.get().showTabbarFragment
        );
        if (mConfigDataReference.get().alwaysShowHandleFragment) {
            //加载 HandleFragment
            handleShowHide(mConfigDataReference.get().showHandleFragment);
        }
    ...
    public void handleShowHide(boolean isShow) {
        ...
        if (mConfigDataReference.get().showHandleFragment && mConfigDataReference.get().handleItemListeners != null) {
            FragmentTools.fragmentShowHide(
                    fragmentManager,
