...
public class GLES20Canvas implements GLCanvas {
    ...
    private void setMatrix(ShaderParameter[] params, float x, float y, float width, float height, ICustomMVPMatrix customMVPMatrix) {
        ...
        //printMatrix("translate matrix mMatrices:" + this, mMatrices, mCurrentMatrixIndex);
    ...
    private void drawTextureRect(BasicTexture texture, float[] textureMatrix, RectF target, ICustomMVPMatrix customMVPMatrix) {
        ...
        //printMatrix("texture matrix " + this, textureMatrix, 0);
    ...
    public void setTextureParameters(BasicTexture texture) {
        ...
        if(target == GLES20.GL_TEXTURE_2D) {
            GLES32.glTexParameteri(target, GLES32.GL_TEXTURE_WRAP_S, GLES32.GL_CLAMP_TO_BORDER);
            GLES32.glTexParameteri(target, GLES32.GL_TEXTURE_WRAP_T, GLES32.GL_CLAMP_TO_BORDER);
        }else{
