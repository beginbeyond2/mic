 ...
 */
abstract class BaseGLCanvasTextureView extends BaseGLTextureView implements GLViewRenderer , ITextureRefresh {
    ...
    public void onSurfaceChanged(int width, int height) {
        Loggers.d(TAG, "onSurfaceChanged: width= " + width + " ,height= " + height);
